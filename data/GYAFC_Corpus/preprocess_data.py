...
def write_processed_files(ori_file_name_read, file_name_write,min_seq_len, max_seq_len):
	'''
	ori_file_name : path tp the ori_file that we want to read from
	'''
...
write_processed_files('./adding_two_datasets/data_model/data_before_preprocessed/sentiment.dev.0', './adding_two_datasets/data_model/data_preprocessed/sentiment.dev.0',3,31)
