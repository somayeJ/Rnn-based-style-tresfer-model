...
def get_batch(x, y, word2id, noisy=False, min_len=5):
    ...
    for sent in x:
        ...
        sents.append(sent)
    print(222222222222222222222222222222222222222222222222,len(weights_input), len(weights_input[0]))
    print('**********',len(weights_input), len(weights_input[0]))
