...
class Model(object):
    def __init__(self, args, vocab):
        ...
        soft_h_ori, soft_logits_ori ,context_vector_seq_sori= rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,
            self.src_contexts0,self.h_ori, go, self.weights_input,self.batch_len_input,max_len,cell_g, soft_func, scope='generator')
        # x_fake
        soft_h_tsf, soft_logits_tsf,context_vector_seq_stsf = rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,
            self.src_contexts0,self.h_tsf, go, self.weights_input,self.batch_len_input,max_len,  cell_g, soft_func, scope='generator')
        hard_h_ori, self.hard_logits_ori,context_vector_seq_hori = rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,
            self.src_contexts0,self.h_ori, go, self.weights_input,self.batch_len_input,max_len,cell_g, hard_func, scope='generator')
        hard_h_tsf, self.hard_logits_tsf,context_vector_seq_htsf = rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,
            self.src_contexts0,self.h_tsf, go,self.weights_input,self.batch_len_input, max_len, cell_g, hard_func, scope='generator')

        teach_h,g_logits,self.context_vector_seq_teach0 = rnn_decode('teacher_force',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,
            self.src_contexts0,self.h_ori,go, self.weights_input, self.batch_len_input,max_len, cell_g,proj_func,scope='generator')
