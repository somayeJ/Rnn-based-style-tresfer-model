...
def rnn_decode(mode,z,dim_h,batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,src_context,h, inp,  weights_input,batch_len_input,length, cell, loop_func, scope):
    ...
    with tf.variable_scope(scope):
        ...
        if mode=='':
            ...
            for t in range(length):
                ...
                context_vector0 = attention(dim_h,batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,output,weights_input,batch_len_input,src_context)
            ...
            for t in range(21):
                ...
                context_vector = attention(dim_h,batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,output,weights_input,batch_len_input,src_context)
                print('inp',inp)
                print('output',output)
                print(mode,t,'t')
