...
class Model(object):
    def __init__(self, args, vocab):
        ...
        teach_h,g_logits,self.context_vector_seq_teach0 = rnn_decode('teacher_force',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,b_score2,W_score3,b_score3,self.src_contexts0,self.h_ori,go, self.weights_input,
