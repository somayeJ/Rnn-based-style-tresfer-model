...
class Model(object):
    def __init__(self, args, vocab):
        ...
        print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
        print('length_output',length_output)
        print('length_output[0].value',length_output[0].value)
        print('self.dec_inputs.get_shape()',dec_inputs.get_shape())

        teach_h,g_logits = rnn_decode('teacher_force',dec_inputs,self.z2,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts,self.h_ori,go, self.weights_input,self.batch_len_input,max_len,
        ...
        soft_h_ori, soft_logits_ori = rnn_decode('',dec_inputs,self.z2,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts,self.h_ori, go, self.weights_input,self.batch_len_input,max_len,
            cell_g, soft_func, scope='generator')
        # x_fake
        soft_h_tsf, soft_logits_tsf = rnn_decode('',dec_inputs,self.z2,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts,self.h_tsf, go, self.weights_input,self.batch_len_input,max_len,
            cell_g, soft_func, scope='generator')
        hard_h_ori, self.hard_logits_ori = rnn_decode('',dec_inputs,self.z2,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts,self.h_ori, go, self.weights_input,self.batch_len_input,max_len,
            cell_g, hard_func, scope='generator')
        hard_h_tsf, self.hard_logits_tsf = rnn_decode('',dec_inputs,self.z2,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts,self.h_tsf, go,self.weights_input,self.batch_len_input, max_len,
            cell_g, hard_func, scope='generator')
