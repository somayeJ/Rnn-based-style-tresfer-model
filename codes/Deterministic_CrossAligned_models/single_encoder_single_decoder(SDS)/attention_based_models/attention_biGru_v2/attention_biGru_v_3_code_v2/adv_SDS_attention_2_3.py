...
class Model(object):
    def __init__(self, args, vocab):
        ...
        self.z2 = tf.concat([linear(labels, dim_y,
            scope='generator', reuse=True), self.z1 ], 1)# [batch_size,700]
        ...
        soft_h_ori, self.soft_logits_ori ,self.context_vector_seq_sori, self.attention_w_seq_sori= rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts0,self.h_ori, go,end, self.weights_input,self.batch_len_input,max_len,
            cell_g, soft_func, scope='generator')
        # x_fake
        soft_h_tsf, self.soft_logits_tsf,self.context_vector_seq_stsf,self.attention_w_seq_stsf = rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts0,self.h_tsf, go, end,self.weights_input,self.batch_len_input,max_len,
            cell_g, soft_func, scope='generator')
        hard_h_ori, self.hard_logits_ori,self.context_vector_seq_hori,self.attention_w_seq_hori = rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts0,self.h_ori, go, end,self.weights_input,self.batch_len_input,max_len,
            cell_g, hard_func, scope='generator')
        hard_h_tsf, self.hard_logits_tsf,self.context_vector_seq_htsf,self.attention_w_seq_htsf = rnn_decode('',self.z0,dim_h,self.batch_size,W_score1,b_score1,W_score2,self.src_contexts0,self.h_tsf, go,end,self.weights_input,self.batch_len_input, max_len,
            cell_g, hard_func, scope='generator')

        self.teach_h,self.g_logits0,self.context_vector_seq_teach0 ,self.attention_w_seq_teach0= rnn_decode('teacher_force',self.z0,dim_h,self.batch_size,
            W_score1,b_score1,W_score2,self.src_contexts0,self.h_ori,go, end,self.weights_input, self.batch_len_input,max_len, cell_g,proj_func,scope='generator')
        ...
        if args.train:
            ...
            for epoch in range(1, 1+args.max_epochs):
                ...
                for batch in batches:
                    ...
                    print('batchsize',len(batch['enc_inputs']))
                    print('batch[len],$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(batch['len'])
                    print('size$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(batch['size'])
                    print('enc_inputs$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(len(batch['enc_inputs']),len(batch['enc_inputs'][0]),batch['enc_inputs'][0])
                    print('dec_inputs$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(len(batch['dec_inputs'][0]),batch['dec_inputs'][0],len(batch['dec_inputs']))
                    print('targets$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(len(batch['targets']),batch['targets'][0],len(batch['targets'][0]))
                    print('weights$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(batch['weights'][0])
                    print('labels$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(len(batch['labels']),batch['labels'][0],batch['labels'])
                    print('weights_input$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(len(batch['weights_input']),len(batch['weights_input'][0]), batch['weights_input'][0])
                    print('len_input$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
                    print(batch['len_input'])
