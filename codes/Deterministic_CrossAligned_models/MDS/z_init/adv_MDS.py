...
class Model(object):
    ...
    def __init__(self, args, vocab):
        ...
        self.z0 = z0[:, dim_y:]
        print('self.z1',self.z0)  # print(z): Tensor("strided_slice:0", shape=(?, 500), dtype=float32)
        ...
        self.grad_rec_norm0 = tf.global_norm(grad_rec0) #  this operation returns the global norm of the elements in all tensors in grad_rec0. 
        # The global norm is computed as:global_norm = sqrt(sum([l2norm(t)**2 for t in grad_rec0]))
        ...
        if args.train:
            ...
            for epoch in range(1, 1+args.max_epochs):
                ...
                if args.dev:
                    ...
                    values, names = dev_losses.output_list()
