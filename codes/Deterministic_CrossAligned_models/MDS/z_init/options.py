...
def load_arguments():
    ...
    argparser.add_argument('--keep_data_order',
            type=bool,
            default=False) # Assigning this arg to True, keeps the data order and does not reorder data based on the the seq, len, which is is good for when we want to compare two files seq embeddings of the pairs
