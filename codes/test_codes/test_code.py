...
if __name__ == '__main__':
    ...
    #####   data preparation   #####
    if args.train:
        train0 = load_sent(args.train + '.0', args.max_train_size)[:2]
        train1 = load_sent(args.train + '.1', args.max_train_size)[:2]
    ...
    if args.dev:
        dev0 = load_sent(args.dev + '.0')[:2]
        dev1 = load_sent(args.dev + '.1')[:2]
