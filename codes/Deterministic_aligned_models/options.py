...
def load_arguments():
    ...
    argparser.add_argument('--train',
            type=str,
            default='')
    argparser.add_argument('--train_classifier',
            type=str,
            default='')
    ...
    argparser.add_argument('--test',
            type=str,
            default='')
    argparser.add_argument('--dev_classifier',
            type=str,
            default='')
    argparser.add_argument('--test_classifier',
            type=str,
            default='')
    ...
    argparser.add_argument('--keep_data_order', 
            type=bool,
            default=False)
    argparser.add_argument('--classification_z',
            type=bool,
            default=False)
    argparser.add_argument('--output',
            type=str,
            default='')
    argparser.add_argument('--output_classifier',
            type=str,
            default='')
    ...
    argparser.add_argument('--model',
            type=str,
            default='')
    argparser.add_argument('--model2',
            type=str,
            default='')
    argparser.add_argument('--new_model',
            type=str,
            default='')
    argparser.add_argument('--load_model',
            type=bool,
            default=False)
    argparser.add_argument('--load_model2',
            type=bool,
            default=False)
    ...
    argparser.add_argument('--n_filters',
            type=int,
            default=128)
    argparser.add_argument('--vector_rep_input',
            type=str,
            default='')
